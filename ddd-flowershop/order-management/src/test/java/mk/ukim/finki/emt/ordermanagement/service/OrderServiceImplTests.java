...
public class OrderServiceImplTests {
    ...
    private static Product newProduct(String name,String description, Money price) {
        Product p = new Product(ProductId.randomId(ProductId.class), name, description, price, 0);
        return p;
    }
